...
export class SampleDemo extends Component {
    ...
    render(){
        ...
        let dialogFooter= <div className="ui-dialog-buttonpane ui-helper-clearfix">
                    <Button label="Login" icon="fa fa-user" onClick={()=>this.setState({dialogValue:false})}/>
                </div>;
        ...
        let menuItems = [
            {
                ...
                items: [
                    ...
                    {label: 'Open', icon: 'fa fa-external-link-square'}
                ]
            },
            {
                label: 'Edit',
                items: [
                    {label: 'Undo', icon: 'fa fa-undo'},
                ...
                <div className="ui-g-12">
                    ...
                    <div className="card no-margin">
                        ...
                        <div className="ui-g form-group">
                            ...
                            <div className="ui-g-12 ui-md-4">
                                <Button label="Edit" icon="fa fa-pencil" />
                            </div>
                            <div className="ui-g-12 ui-md-2">
                                SplitButton
                            </div>
                            <div className="ui-g-12 ui-md-4">
                                <SplitButton label="Save" icon="fa fa-check" model={splitButtonItems}/>
                            </div>
                            <div className="ui-g-12 ui-md-2">
                            ...
                            <div className="ui-g-12 ui-md-4">
                                <Button label="Login" icon="fa fa-external-link" onClick={()=>this.setState({dialogValue:true})}/>
                            </div>
                        </div>
