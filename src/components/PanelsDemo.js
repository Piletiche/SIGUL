...
export class PanelsDemo extends Component {
    ...
    render(){
        let items = [
            {label: 'React', icon: 'fa fa-link', url: 'https://facebook.github.io/react/'},
            {label: 'Theming', icon: 'fa fa-paint-brush', url: 'https://primefaces.org/primereact/#/theming'}
        ];
                    ...
                    <div className="card card-w-title">
                        ...
                        <Toolbar>
                            <div className="ui-toolbar-group-left">
                                <Button label="New" icon="fa fa-plus" />
                                <Button label="Update" icon="fa fa-refresh" className="pink-btn" />

                                <i className="fa fa-bars" style={{marginRight:'.25em'}}></i>
                                <SplitButton label="Save" icon="fa fa-check" model={items}/>
                                
                            </div>

                            <div className="ui-toolbar-group-right">
                                <Button icon="fa fa-check" className="green-btn"/>
                                <Button icon="fa fa-trashÖover" className="purple-btn"/>
                                <Button icon="fa fa-print" className="orange-btn"/>
                            </div>
                        </Toolbar>
                    </div>
                </div>
