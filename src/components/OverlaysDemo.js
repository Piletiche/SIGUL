...
export class OverlaysDemo extends Component {
    ...
    render(){
        ...
        let dialogFooter = <div className="ui-dialog-buttonpane ui-helper-clearfix">
            <Button icon="fa fa-close" onClick={()=>this.setState({display:false})} label="No"/>
            <Button icon="fa fa-check" onClick={()=>this.setState({display:false})} label="Yes"/>
        </div>;
            ...
            <div className="ui-g ui-fluid">
                <div className="ui-g-12 ui-lg-6">
                    ...
                    <div className="card">
                        ...
                        <Button icon="fa fa-external-link-square" label="Show" onClick={()=> this.setState({display: true})}/>
                    </div>
                </div>
                <div className="ui-g-12 ui-lg-6">
                    {/* Right Side */}
