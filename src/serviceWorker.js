...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      ...
      // do que nossa página é veiculada. Isso pode acontecer se uma CDN for usada para
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        // Adicione alguns logs adicionais ao localhost, apontando os desenvolvedores para o
